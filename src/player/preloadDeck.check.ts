...
// The IFrame deck disables preloading on mobile to prevent expired signed URL errors
check(!hasPreloadDeck("iframe", streamed), "iframe does not preload streamed tracks to avoid expired chunks");

...
export function SelectTrigger({ className, children }: SelectTriggerProps) {
  ...
  return (
    <motion.button
      ...
      className={cn(
        "relative z-10 flex w-full items-center justify-between gap-2 rounded-xl border border-border/40 bg-card/70 px-3.5 py-2 text-sm text-foreground outline-none transition-colors whitespace-nowrap",
        "hover:bg-card hover:border-border/80 focus-visible:ring-2 focus-visible:ring-foreground/20",
...
export function SelectValue({ placeholder, className }: SelectValueProps) {
  ...
  return (
    <span
      className={cn("truncate whitespace-nowrap min-w-0 flex-1 text-left", label ? "text-foreground" : "text-muted-foreground", className)}
    >

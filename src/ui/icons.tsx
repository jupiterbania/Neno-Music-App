...
export { LikeIcon } from "@solar-icons/react/linear/like";
export { LikeIcon as LikeActiveIcon } from "@solar-icons/react/bold/like";
export { ScreencastIcon } from "@solar-icons/react/linear/screencast";
export { MenuDotsIcon } from "@solar-icons/react/linear/menu-dots";
export { ShareIcon } from "@solar-icons/react/linear/share";
/** 6-dots vertical grip handle icon for reordering tracks */
export function DragHandleIcon({ size = 20, ...props }: SVGProps<SVGSVGElement> & { size?: number | string }) {
  return (
    <svg
...
export { HeadphonesRoundIcon } from "@solar-icons/react/linear/headphones-round";

/** YouTube Music Vertical Three Dots (Kebab menu) */
export function MoreVerticalIcon({ size = 24, ...props }: SVGProps<SVGSVGElement> & { size?: number | string }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
/** YouTube Music Double Quotes icon for Lyrics */
export function QuoteIcon({ size = 20, ...props }: SVGProps<SVGSVGElement> & { size?: number | string }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
/** YouTube Music Save / Playlist-Add icon */
export function YTSaveIcon({ size = 20, ...props }: SVGProps<SVGSVGElement> & { size?: number | string }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
/* ── Search Experience Icons ────────────────────────────────────────── */

export function ArrowUpRightIcon({ size = 20, ...props }: SVGProps<SVGSVGElement> & { size?: number | string }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function MicIcon({ size = 24, ...props }: SVGProps<SVGSVGElement> & { size?: number | string }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function WaveformIcon({ size = 24, ...props }: SVGProps<SVGSVGElement> & { size?: number | string }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function TrendingUpIcon({ size = 24, ...props }: SVGProps<SVGSVGElement> & { size?: number | string }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function SmileFaceIcon({ size = 24, ...props }: SVGProps<SVGSVGElement> & { size?: number | string }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function PodcastIcon({ size = 24, ...props }: SVGProps<SVGSVGElement> & { size?: number | string }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
    ...
    >
      ...
      <path d="M12 12a3 3 0 0 0 3-3V7a3 3 0 1 0-6 0v2a3 3 0 0 0 3 3Z" />
...
export function DiscNoteIcon({ size = 24, ...props }: SVGProps<SVGSVGElement> & { size?: number | string }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"

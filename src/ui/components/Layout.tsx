  ...
  return (
    <div className="relative flex min-h-0 flex-1 overflow-hidden bg-background ">
      ...
      <div className="relative flex min-h-0 min-w-0 flex-1">
        ...
        <div className={cn(
          "relative flex min-h-0 min-w-0 flex-1 flex-col gap-3 bg-background",
          isMobile ? "px-2 pt-[max(env(safe-area-inset-top,0px),10px)] rounded-none" : "px-4 pt-3 rounded-tl-lg"
        )}>
          {/*
          ...
          */}
          ...
          <div className="relative flex min-h-0 min-w-0 flex-1 gap-3 pb-3 ">
            <div className="relative min-h-0 min-w-0 flex-1">
              ...
              {!isMobile && showTransientScrollbar && scrollbarState.canScroll && (
                <div
                  className={cn(

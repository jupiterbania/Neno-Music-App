...
export const AlbumCard = memo(function AlbumCard({
  ...
  return (
    <div
       ...
       */
      className="group/card flex w-full cursor-pointer flex-col gap-2 rounded-xl p-1.5 sm:p-2 transition-all hover:bg-card/75 active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-ring [content-visibility:auto] [contain-intrinsic-size:auto_232px]"
      onClick={handleClick}
      ...
      tabIndex={0}
    >
      <TiltCard max={9} className="aspect-square w-full overflow-hidden rounded-xl sm:rounded-2xl border border-white/10 shadow-sm">
      ...
      <div className="flex min-w-0 flex-col gap-0.5 px-0.5 pointer-events-none">
        ...
        {(subtitleContent || subtitle) && (
          <span className="line-clamp-1 text-[11px] sm:text-xs text-muted-foreground leading-tight">
            {subtitleContent ?? subtitle}
          </span>
        )}
      </div>

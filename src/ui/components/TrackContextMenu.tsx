  ...
  return (
    <TrackContextMenuContext.Provider value={contextValue}>
      ...
      {menuPosition && track && (
        <div
          ref={menuRef}
          className="fixed z-[100] flex min-w-56 flex-col gap-0.5 rounded-xl bg-popover/95 p-1.5 shadow-2xl backdrop-blur"
      ...
      {toast && (
        <div className="fixed bottom-28 left-1/2 z-[110] flex -translate-x-1/2 items-center gap-2 rounded-full bg-popover/95 px-4 py-2 text-sm text-foreground shadow-2xl backdrop-blur" role="status">

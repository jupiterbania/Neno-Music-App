...
export const isMacOS =
  typeof navigator !== "undefined" && !isMobileDevice && /Macintosh|Mac OS X/.test(navigator.userAgent);

export const isLinux =
  typeof navigator !== "undefined" && !isAndroid && /Linux/.test(navigator.userAgent);
...
export function applyPlatformAttributes() {
  ...
  document.documentElement.toggleAttribute("data-mobile", isMobileDevice);
}

  ...
  return (
    <div className="flex flex-col gap-8">
      <MediaHeader
        ...
        artworkSlot={
          <TrackArtwork
            className="size-24 sm:size-36 lg:size-44 shrink-0 rounded-full bg-card shadow-2xl ring-1 ring-white/10"
            size={144}
            artworkUrl={displayedArtist.artworkUrl}
            iconSize={48}
            variant="artist"
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            */}
            {isSubscribed && (
              ...
              >
                <SelectTrigger className="h-10 rounded-full border border-white/10 bg-card/70 px-3 text-xs sm:text-sm hover:bg-card" aria-label={`Notifications for ${displayedArtist.name}`}>
